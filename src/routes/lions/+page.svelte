<div class="flex flex-col items-center bg-red-800 p-4">
    <img src="http://rugbyapi.shineconsultglobal.com/storage/images/lions.jpg" alt="British Lions" class="h-48 w-full object-contain" />
    <span class="text-lg text-center font-bold">Win the once in a life time trip to Australia to see the British Lion on Tour</span>
    <form class="max-w-sm mt-4 mx-auto" method="POST" action="?/sale">
        ...
        <div class="mb-5">
            <button  class="rounded-full bg-black px-4 py-2 text-white transition-colors duration-300">Enter Prize Draw</button>
        </div>
    </form>
</div>